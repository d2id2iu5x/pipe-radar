...
describe("Cloudflare static build", () => {
  it("includes every browser module imported by index.html", () => {
    expect(pipeRadarStaticFiles("/project").map(file => file.target)).toEqual(expect.arrayContaining([
      "src/client/remote-data.js",
      "src/client/status-view.js"
    ]));
  });
